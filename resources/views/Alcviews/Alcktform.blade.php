        ...
        <div class="col-8 mt-3">
          ...
          <form method="POST" action="ktform">
            ...
            <div class="form-group">
              ...
              <div class="radio">
                <label><input type="radio" name="type" value="category">カテゴリー</label>
                <label><input type="radio" name="type" value="tag">タグ</label>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="row">
              <div class="col-9"></div>
              <div class="col-3">
                <button type="submit" class="btn btn-primary mb-3 mt-3">追加</button>
              </div>
            </div>
          </form>
        </div>
